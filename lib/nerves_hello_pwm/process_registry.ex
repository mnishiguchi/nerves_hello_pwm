defmodule NervesHelloPwm.ProcessRegistry do
  ...
  ## Examples
      ProcessRegistry.via_tuple({SomeModule, 20})
      # {:via, Registry, {MyApp.ProcessRegistry, {MyApp.SomeModule, 20}}}
  """
  ...
  Examples:
      ProcessRegistry.whereis_name({SomeModule, 20})
      # #PID<0.235.0>
  """
